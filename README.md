# RTC Go Server
This is a server to process RTC connections between browser clients and "server clients", that are spwaned on-demand, and to process the audio through a Speech-to-Text.   
