...
func riaSaysHello(ae *rtc_client.AudioEngine, rtc *rtc_client.RTCConnection, client_id string) int {
	...
	for {
		...
		if resp.StatusCode == http.StatusOK {
			...
			data := make([]float32, 247350) // india ring time = 7.08s, US ring time 4.19s. need to prepend silence of 10s more ie, 220500 more(22050*10 = 220500). So, 26850+220500=247350
